 ...
 */
	public Utilisateur(int noUtlisateur, String pseudo, String nom, String prenom, String email, String telephone, String rue,
...
public String toString() {
	return "Utilisateur [noUtlisateur=" + noUtlisateur + ", pseudo=" + pseudo + ", nom=" + nom + ", prenom=" + prenom
